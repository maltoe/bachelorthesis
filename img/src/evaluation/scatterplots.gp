...
plot 'geolat3.dat' using 2:3 title 'Geo3', x/2.22 title 'calculated average speed up' linestyle 2  
set output
...
!rm scatter_aml4.tmp.eps scatter_geolat3.tmp.eps
!mv scatter_aml4.eps scatter_geolat3.eps ../../
