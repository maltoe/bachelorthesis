...
CPU features that the compiler is not aware of or is not capable of using in the very situation. 
In the following bachelor thesis we are exploring ways to optimize performance of real-world
algorithms using techniques such as parallelisation and manual cache organization. Based
